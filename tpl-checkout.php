			...
			<div class="checkout__container">
				...
				<div class="checkout__phone">
					...
					<div class="checkout__phone--text">
						<p><?php esc_html_e( '"Saada valideerimis kood" nupule vajutades saadetakse Teile SMS 8-kohalise numbriga, mille peate sisestama "Valideerimiskood" välja.', THEME_TEXT_DOMAIN ); ?></p>
